...
if (process.env.OTEL_EXPORTER_OTLP_ENDPOINT) {
  ...
  try { sdk.start(); process.stdout.write(`${JSON.stringify({ level: 'info', message: 'OpenTelemetry tracing habilitado', service: process.env.OTEL_SERVICE_NAME ?? 'pagamentos' })}\n`); }
